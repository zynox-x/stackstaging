...
(() => {
    ...
    const r = function(t, e) {
        ...
        function o() {
            ...
            t: for (; i;) {
                if (i.args.length === arguments.length) {
                    ...
                    return i !== n && (i === r && (r = i.prev), i.prev.next = i.next, i.next && (i.next.prev = i.prev), i.next = n, i.prev = null, n.prev = i, n = i), i.val
                }
                i = i.next
            }
            ...
            return i = {
                args: o,
                val: t.apply(null, o)
            }, n ? (n.prev = i, i.next = n) : r = i, s === e.maxSize ? (r = r.prev).next = null : s++, n = i, i.val
        }
        ...
        let s;
        for (t = t.replace(/[\u00a0\u200b]/g, " "); s = r.exec(t);) s[1] ? e[s[1].toLowerCase()] = s[2] : s[3] ? e[s[3].toLowerCase()] = s[4] : s[5] ? e[s[5].toLowerCase()] = s[6] : s[7] ? n.push(s[7]) : s[8] ? n.push(s[8]) : s[9] && n.push(s[9]);
        return {
            named: e,
            numeric: n
        }
    ...
    const o = Object.assign((function(t) {
        ...
        next: function t(e, r, o = 0) {
            ...
            return i[1] && (a.content = a.content.slice(1), a.index++), i[7] && (a.content = a.content.slice(0, -1)), a
        },
